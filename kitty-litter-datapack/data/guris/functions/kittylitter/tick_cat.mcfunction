...
execute if score @s guris.kittylitter < config_kittylitter_cats_cooldown guris.kittylitter run scoreboard players add @s guris.kittylitter 1

# shiver if needs to take dump but cannot
execute if score config_kittylitter_shiver guris.kittylitter matches 1 if score @s guris.kittylitter >= config_kittylitter_cats_cooldown guris.kittylitter run data modify entity @s TicksFrozen set value 140

# try to take a dump (set status) - will start the motion
execute if score @s guris.kittylitter >= config_kittylitter_cats_cooldown guris.kittylitter if predicate guris:kittylitter/on_sand run function guris:kittylitter/dump_start_cat
...
execute if score @s guris.kittylitter matches 0 run function guris:kittylitter/dump_end_cat